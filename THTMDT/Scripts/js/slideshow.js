...
var birdTexts = [
    ...
    "Bệnh viện Hoàn Kim được trang bị hệ thống thiết bị máy móc hiện đại, sẵn sàng đáp ứng mọi nhu cầu khám chữa bệnh kỹ thuật cao cho người dân, nhất là các bệnh cần điều trị chuyên sâu chưa phổ biến ở các bệnh viện hiện nay như Thanh học, Thính học, Tiền đình.",
    "Bệnh viện Hoàn Kim hiện áp dụng khám tai mũi họng trong giờ. Giờ khám tai mũi họng của chúng tôi là từ 7 giờ sáng – 16 giờ chiều các ngày từ thứ 2 – thứ 7 hàng tuần."
];

var birdTitles = ["Tại sao lại khám tai mũi họng", "Vì sao bị bệnh về tai mũi họng", "Khám tai mũi họng là gì", "Khám tai mũi họng ở đâu cho tốt", "Giờ hoạt động"];
